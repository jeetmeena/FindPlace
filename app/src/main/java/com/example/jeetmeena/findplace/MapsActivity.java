...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, DrawerLayout.DrawerListener,
    ...
    private static final String BROWSER_API_KEY = "AIzaSyAPbBLFDMTeTnWlbgHWnHFRmlIi9eNlio0";
  ...
  static  String city="Gandhi Nagar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whereGo.setAdapter(new GooglePlacesAutocompleteAdapter(this,R.layout.search_list));
      // whereGo.setAdapter(new GooglePlacesAutocompleteAdapter(this, R.layout.list_item));
     /* mPlaceAutocompleteFragment= (PlaceAutocompleteFragment) getFragmentManager().findFragmentById(R.id.place_autocomplete);
        mPlaceAutocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                Toast.makeText(MapsActivity.this,"On location  "+place,Toast.LENGTH_LONG).show();
    ...
    public void goToThisLocation(int count,double lat, double lng, float zom) {
       ...
       // String rating= getDataStarRating(index,data.getIdChild());
            ...
            Marker m = mMap.addMarker(new MarkerOptions()
                    .position(ll)
                    .title(String.valueOf(data.getModOfToilet()))
   ...
   public void textCheang(){
        ...
        switch(item.getItemId()){
            ...
            case  R.id.nav_list:
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.mapsa,
                       new ListVi(MapsActivity.this,toiletRetDatassd,stringArrayList)).commit();
    ...
    public static ArrayList autocomplete(String input) {
        ...
        try {
            ...
            Log.e("tyu", "Cannot process JSON results", e);
