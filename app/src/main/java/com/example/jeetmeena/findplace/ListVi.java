...
public class ListVi extends Fragment  {
  ...
  //  UserInformation userInfo;
   ...
   ArrayList<String> stringArrayList=new ArrayList<>();
    ...
    @SuppressLint("ValidFragment")
    public ListVi(Context context, ArrayList<ToiletRetData> toiletRetData, ArrayList<String> stringArrayList) {
        contexts=context;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return view;
           ...
           public class SimpleRVAdapter extends RecyclerView.Adapter<SimpleViewHolder> {
            ...
            public void onBindViewHolder(final SimpleViewHolder holder, final int position) {
                ...
                holder.cost.setText(listDataa.get(position).getCostOfToilet());
                holder.city.setText(listDataa.get(position).getAddressLocat());
                holder.textStar.setText(stringArrayList.get(position));
        ...
        public class SimpleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public SimpleViewHolder(View itemView, Context context, ArrayList<ToiletRetData> listDataa) {
                ...
                txtname = (TextView) itemView.findViewById(R.id.namead);
